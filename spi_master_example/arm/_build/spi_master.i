...
{
    if ((((NRF_SPI_Type *) 0x40004000UL)->EVENTS_READY == 1) && (((NRF_SPI_Type *) 0x40004000UL)->INTENSET & (0x1UL << (2UL))))
    {
...
{		
    ...
    switch (spi_master_hw_instance)
    {
        ...
        case SPI_MASTER_1:
            spi_master_init_hw_instance(((NRF_SPI_Type *) 0x40004000UL), SPI1_TWI1_IRQn, p_spi_instance, p_spi_master_config->SPI_DisableAllIRQ);
            break;
                              ...
                              uint8_t * const p_rx_buf, const uint16_t rx_buf_len)
{
    ...
    {   
        ...
        do { const uint32_t LOCAL_ERR_CODE = (sd_nvic_critical_region_exit(nested_critical_region)); if (LOCAL_ERR_CODE != ((0x0) + 0)) { do { app_error_handler((LOCAL_ERR_CODE), 472, (uint8_t*) "..\\..\\..\\..\\Source\\spi_master\\spi_master.c"); } while (0); } } while (0);
    }
    else
    {
        
        do { const uint32_t LOCAL_ERR_CODE = (sd_nvic_EnableIRQ(p_spi_instance ->irq_type)); if (LOCAL_ERR_CODE != ((0x0) + 0)) { do { app_error_handler((LOCAL_ERR_CODE), 477, (uint8_t*) "..\\..\\..\\..\\Source\\spi_master\\spi_master.c"); } while (0); } } while (0);
    }
