...
#line 47 "..\\..\\..\\..\\Include\\app_common\\app_error.h"




     
#line 61 "..\\..\\..\\..\\Include\\app_common\\app_error.h"
    



     
#line 75 "..\\..\\..\\..\\Include\\app_common\\app_error.h"



 
#line 29 "..\\main.c"
#line 1 "..\\..\\..\\..\\Include\\sdk_soc\\app_util_platform.h"
...
#line 17 "..\\..\\..\\..\\Include\\sdk_soc\\app_util_platform.h"
#line 18 "..\\..\\..\\..\\Include\\sdk_soc\\app_util_platform.h"
#line 19 "..\\..\\..\\..\\Include\\sdk_soc\\app_util_platform.h"
#line 20 "..\\..\\..\\..\\Include\\sdk_soc\\app_util_platform.h"
...
static uint8_t m_tx_data_spi[100];  
static uint8_t m_rx_data_spi[100];  

static volatile _Bool m_transfer_completed = 1;
...
static _Bool check_buf_equal(const uint8_t * const p_tx_buf,
                            ...
                            const uint16_t len)
{
		...
		simple_uart_putstring((const uint8_t *) p_rx_buf[0]);						
...
void spi_master_0_event_handler(spi_master_evt_t spi_master_evt)
{
    ...
    switch (spi_master_evt.evt_type)
    {
        case SPI_MASTER_EVT_TRANSFER_COMPLETED:
            ...
            result = check_buf_equal(m_tx_data_spi, m_rx_data_spi, 100);
            if (!result)
            {
                
                
								simple_uart_putstring((const uint8_t *) "\r\nDone with Error, spi master...[OK]\r\n");	
            }
            do { const _Bool LOCAL_BOOLEAN_VALUE = (result); if (!LOCAL_BOOLEAN_VALUE) { do { app_error_handler((0), 164, (uint8_t*) "..\\main.c"); simple_uart_putstring((const uint8_t *)"\r\nError caught by handler...\t[FAILURE]\r\n"); } while (0); } } while (0);
        
            
            spi_master_close(SPI_MASTER_0);
        
            m_transfer_completed = 1;
            break;
    ...
    switch (spi_master_evt.evt_type)
    {
        case SPI_MASTER_EVT_TRANSFER_COMPLETED:
            ...
            {    
                ...
                nrf_gpio_pin_set(9UL);
            }
            do { const _Bool LOCAL_BOOLEAN_VALUE = (result); if (!LOCAL_BOOLEAN_VALUE) { do { app_error_handler((0), 195, (uint8_t*) "..\\main.c"); simple_uart_putstring((const uint8_t *)"\r\nError caught by handler...\t[FAILURE]\r\n"); } while (0); } } while (0);
                            ...
                            const _Bool lsb)
{
    ...
    switch (spi_master_instance)
    {
        ...
        case SPI_MASTER_0:
        {
            spi_config.SPI_Pin_SCK = 4u;
            spi_config.SPI_Pin_MISO = 5u;
            spi_config.SPI_Pin_MOSI = 6u;
            spi_config.SPI_Pin_SS = 2u;
        }
        break; 
        ...
        case SPI_MASTER_1:
        {
            spi_config.SPI_Pin_SCK = 29u;
            spi_config.SPI_Pin_MISO = 23u;
            spi_config.SPI_Pin_MOSI = 21u;
            spi_config.SPI_Pin_SS = 28u;
        }
        break;
    ...
    spi_config.SPI_CONFIG_ORDER = (lsb ? (1UL) : (0UL));
		spi_config.SPI_CONFIG_CPOL = (1UL);
		spi_config.SPI_CONFIG_CPHA = (1UL);
    
    err_code = spi_master_open(spi_master_instance, &spi_config);
    do { const uint32_t LOCAL_ERR_CODE = (err_code); if (LOCAL_ERR_CODE != ((0x0) + 0)) { do { app_error_handler((LOCAL_ERR_CODE), 257, (uint8_t*) "..\\main.c"); simple_uart_putstring((const uint8_t *)"\r\nError caught by handler...\t[FAILURE]\r\n"); } while (0); } } while (0);
                          ...
                          const uint16_t len)
{
    ...
    do { const uint32_t LOCAL_ERR_CODE = (err_code); if (LOCAL_ERR_CODE != ((0x0) + 0)) { do { app_error_handler((LOCAL_ERR_CODE), 280, (uint8_t*) "..\\main.c"); simple_uart_putstring((const uint8_t *)"\r\nError caught by handler...\t[FAILURE]\r\n"); } while (0); } } while (0);
}
...
static void switch_state(void)
{
    switch (m_spi_master_ex_state)
    {
        ...
        case TEST_STATE_SPI0_MSB:
            spi_master_init(SPI_MASTER_0, spi_master_0_event_handler, 0);
        ...
        case TEST_STATE_SPI1_LSB:
            spi_master_init(SPI_MASTER_1, spi_master_1_event_handler, 1);
        
            spi_send_recv(SPI_MASTER_1, m_tx_data_spi, m_rx_data_spi, 100);
        ...
        case TEST_STATE_SPI1_MSB:
            spi_master_init(SPI_MASTER_1, spi_master_1_event_handler, 0);
...
int main(void)
{
		...
		simple_uart_config(19, 3, 18, 1, 0);
    ...
    ((NRF_GPIOTE_Type *) 0x40006000UL)->CONFIG[0]   = ((0x03UL) << (16UL)) |
                              (10 << (8UL)) |
                              ((0x03UL) << (0UL));

    ((NRF_PPI_Type *) 0x4001F000UL)->CH[0].EEP      = (uint32_t)&(((NRF_SPI_Type *) 0x40003000UL)->EVENTS_READY);
    ...
    ((NRF_GPIOTE_Type *) 0x40006000UL)->CONFIG[1]   = ((0x03UL) << (16UL)) |
                              (11 << (8UL)) |
                              ((0x03UL) << (0UL));

    ((NRF_PPI_Type *) 0x4001F000UL)->CH[1].EEP      = (uint32_t)&(((NRF_SPI_Type *) 0x40004000UL)->EVENTS_READY);
    ((NRF_PPI_Type *) 0x4001F000UL)->CH[1].TEP      = (uint32_t)&((NRF_GPIOTE_Type *) 0x40006000UL)->TASKS_OUT[1];
    ((NRF_PPI_Type *) 0x4001F000UL)->CHEN          |= ((1UL) << (1UL));
    ...
    for (;;)
    {
        ...
        {
            m_transfer_completed = 0;
						simple_uart_putstring((const uint8_t *)" \n\rData Transfer 0x00 done...\t[OK]\r\n ");
            switch_state();						
        }
    }
