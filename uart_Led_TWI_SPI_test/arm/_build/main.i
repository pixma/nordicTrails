...
#line 19 "..\\app_util_platform.h"
#line 20 "..\\app_util_platform.h"
...
static void spi_master_event_handler(spi_master_evt_t spi_master_evt)
{
    ...
    switch (spi_master_evt.evt_type)
    {
        case SPI_MASTER_EVT_TRANSFER_COMPLETED:
            ...
            do { const _Bool LOCAL_BOOLEAN_VALUE = (result); if (!LOCAL_BOOLEAN_VALUE) { do { app_error_handler((0), 220, (uint8_t*) "..\\main.c"); } while (0); } } while (0);
...
int main(void)
{
    ...
    simple_uart_config(19, 1, 18, 3, 0);
...
#line 376 "..\\main.c"
						...
						do { const uint32_t LOCAL_ERR_CODE = (err_code); if (LOCAL_ERR_CODE != ((0x0) + 0)) { do { app_error_handler((LOCAL_ERR_CODE), 382, (uint8_t*) "..\\main.c"); } while (0); } } while (0);
