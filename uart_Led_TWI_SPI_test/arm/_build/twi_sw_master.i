...
_Bool twi_master_init(void)
{
    ...
    do { ((NRF_GPIO_Type *) 0x50000000UL)->PIN_CNF[(6U)] = ((0x00UL) << (16UL)) |((0x06UL) << (8UL)) |((0x03UL) << (2UL)) |((0UL) << (1UL)) |((0UL) << (0UL)); } while (0);  
    do { ((NRF_GPIO_Type *) 0x50000000UL)->PIN_CNF[(4U)] = ((0x00UL) << (16UL)) |((0x06UL) << (8UL)) |((0x03UL) << (2UL)) |((0UL) << (1UL)) |((0UL) << (0UL)); } while (0);  

    
    do { ((NRF_GPIO_Type *) 0x50000000UL)->OUTSET = (1UL << (4U)); } while(0);
    do { ((NRF_GPIO_Type *) 0x50000000UL)->DIRSET = (1UL << (4U)); } while(0);

    
    do { ((NRF_GPIO_Type *) 0x50000000UL)->OUTSET = (1UL << (6U)); } while(0);
    do { ((NRF_GPIO_Type *) 0x50000000UL)->DIRSET = (1UL << (6U)); } while(0);
...
static _Bool twi_master_clear_bus(void)
{
    ...
    if (((((NRF_GPIO_Type *) 0x50000000UL)->IN >> (6U)) & 0x1UL) == 1 && ((((NRF_GPIO_Type *) 0x50000000UL)->IN >> (4U)) & 0x1UL) == 1)
    {
        bus_clear = 1;
    }
    else if (((((NRF_GPIO_Type *) 0x50000000UL)->IN >> (4U)) & 0x1UL) == 1)
    {
        bus_clear = 0;
        
        for (uint_fast8_t i = 18; i--;)
        {
            do { ((NRF_GPIO_Type *) 0x50000000UL)->OUTCLR = (1UL << (4U)); } while(0);
            nrf_delay_us(4);
            do { ((NRF_GPIO_Type *) 0x50000000UL)->OUTSET = (1UL << (4U)); } while(0);
            nrf_delay_us(4);

            if (((((NRF_GPIO_Type *) 0x50000000UL)->IN >> (6U)) & 0x1UL) == 1)
            {
                bus_clear = 1;
                break;
            }
...
#line 213 "..\\..\\..\\..\\Source\\twi_master\\twi_sw_master.c"
    ...
    do { ((NRF_GPIO_Type *) 0x50000000UL)->OUTCLR = (1UL << (6U)); } while(0);
    nrf_delay_us(4);
...
static _Bool twi_master_clock_byte(uint_fast8_t databyte)
{
    ...
    do { ((NRF_GPIO_Type *) 0x50000000UL)->DIRCLR = (1UL << (6U)); } while(0);
    ...
    transfer_succeeded &= !(((((NRF_GPIO_Type *) 0x50000000UL)->IN >> (6U)) & 0x1UL));
...
static _Bool twi_master_clock_byte_in(uint8_t *databyte, _Bool ack)
{
    ...
    for (uint_fast8_t i = 0x80; i != 0; i >>= 1)
    {
        ...
        if (((((NRF_GPIO_Type *) 0x50000000UL)->IN >> (6U)) & 0x1UL))
        {
            byte_read |= i;
        }
        else
...
static _Bool twi_master_wait_while_scl_low(void)
{
    ...
    while (((((NRF_GPIO_Type *) 0x50000000UL)->IN >> (4U)) & 0x1UL) == 0)
    {
