#line 1 "..\\..\\..\\..\\Source\\ext_sensors\\ds1624\\ds1624.c"
...
#line 1 "..\\..\\..\\..\\Include\\ext_sensors\\ds1624.h"
...
#line 19 "..\\..\\..\\..\\Include\\ext_sensors\\ds1624.h"
...
#line 20 "..\\..\\..\\..\\Include\\ext_sensors\\ds1624.h"
...
_Bool ds1624_init(uint8_t device_address);
...
_Bool ds1624_temp_read(int8_t *temperature_in_celcius, int8_t *temperature_fraction);
...
_Bool ds1624_start_temp_conversion(void);
...
_Bool ds1624_is_temp_conversion_done(void);
...
#line 14 "..\\..\\..\\..\\Source\\ext_sensors\\ds1624\\ds1624.c"
...
#line 15 "..\\..\\..\\..\\Source\\ext_sensors\\ds1624\\ds1624.c"
#line 1 "..\\..\\..\\..\\Include\\nrf_delay.h"
...
#line 16 "..\\..\\..\\..\\Source\\ext_sensors\\ds1624\\ds1624.c"
...
static uint8_t ds1624_config_read(void)
{
    ...
    if (twi_master_transfer(m_device_address, (uint8_t*)&command_access_config, 1, ((_Bool)0)))
    {
        if (twi_master_transfer(m_device_address | (0x01), &config, 1, ((_Bool)1))) 
        {
...
_Bool ds1624_init(uint8_t device_address)
{
    ...
    m_device_address = 0x90 + (uint8_t)(device_address << 1);
    ...
    if (config != 0)
    {
        ...
        if (!(config & 0x01))
        {
            ...
            transfer_succeeded &= twi_master_transfer(m_device_address, data_buffer, 2, ((_Bool)1));
        }
    }
    else
    {
...
_Bool ds1624_start_temp_conversion(void)
{
    return twi_master_transfer(m_device_address, (uint8_t*)&command_start_convert_temp, 1, ((_Bool)1));
}
...
_Bool ds1624_temp_read(int8_t * temperature_in_celcius, int8_t * temperature_fraction)
{
    ...
    if (twi_master_transfer(m_device_address, (uint8_t*)&command_read_temp, 1, ((_Bool)0)))
    {
        uint8_t data_buffer[2];

        
        if (twi_master_transfer(m_device_address | (0x01), data_buffer, 2, ((_Bool)1))) 
        {
