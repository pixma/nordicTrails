...
int main(void)
{
    ...
    _Bool touchpad_init_succeeded;
    _Bool ds1624_init_succeeded;
    _Bool m_conversion_in_progress = 0;
    ...
    touchpad_init_succeeded     = touchpad_init(0x20);
    ds1624_init_succeeded       = ds1624_init(0x07);
    ...
    while(1)
    {
        ...
        {       
            ...
            if (touchpad_read_register(0x41, &touchpad_button_status))
            {
