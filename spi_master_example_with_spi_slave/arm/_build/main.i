...
#line 88 "..\\..\\..\\..\\Include\\boards/nrf6310.h"




#line 103 "..\\..\\..\\..\\Include\\boards/nrf6310.h"

#line 119 "..\\..\\..\\..\\Include\\boards/nrf6310.h"
...
static uint8_t m_tx_data[16u] = {0};  
static uint8_t m_rx_data[16u] = {0};  
...
static __inline _Bool buf_check(uint8_t * p_buf, uint16_t len)
{
    uint16_t i;
    for (i = 0; i < len; i++)
    {
...
static uint32_t spi_master_init(void)
{
    spi_master_config_t spi_config = { (0x10000000UL), 0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF, APP_IRQ_PRIORITY_LOW, (1UL), (0UL), (0UL), 0 };;
        ...
        spi_config.SPI_Pin_SS = 27u;
#line 111 "..\\main.c"
    
    return spi_master_open(SPI_MASTER_0, &spi_config);
}
...
static void spi_master_event_handler(spi_master_evt_t spi_master_evt)
{
    ...
    switch (spi_master_evt.evt_type)
    {
        case SPI_MASTER_EVT_TRANSFER_COMPLETED:
            ...
            do { const _Bool LOCAL_BOOLEAN_VALUE = (result); if (!LOCAL_BOOLEAN_VALUE) { do { app_error_handler((0), 130, (uint8_t*) "..\\main.c"); } while (0); } } while (0);
                          ...
                          const uint16_t len)
{
    ...
    uint32_t err_code = spi_master_send_recv(SPI_MASTER_0, p_tx_data, len, p_rx_data, len);
    do { const uint32_t LOCAL_ERR_CODE = (err_code); if (LOCAL_ERR_CODE != ((0x0) + 0)) { do { app_error_handler((LOCAL_ERR_CODE), 178, (uint8_t*) "..\\main.c"); } while (0); } } while (0);
...
int main(void)
{
    ...
    for (;;)
    {
        if (m_transfer_completed)
        {
            ...
            spi_send_recv(m_tx_data, m_rx_data, 16u);
        }
    }
}
