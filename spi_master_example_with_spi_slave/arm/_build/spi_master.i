...
#line 1 "..\\..\\..\\..\\Source\\spi_master\\app_error.h"
...
#line 26 "..\\..\\..\\..\\Source\\spi_master\\app_error.h"
...
#line 27 "..\\..\\..\\..\\Source\\spi_master\\app_error.h"
#line 1 "..\\..\\..\\..\\Source\\spi_master\\nrf_error.h"
...
#line 28 "..\\..\\..\\..\\Source\\spi_master\\app_error.h"
...
#line 60 "..\\..\\..\\..\\Source\\spi_master\\app_error.h"
    



     
#line 74 "..\\..\\..\\..\\Source\\spi_master\\app_error.h"
...
#line 17 "..\\..\\..\\..\\Source\\spi_master\\nrf_soc.h"
#line 18 "..\\..\\..\\..\\Source\\spi_master\\nrf_soc.h"
...
#line 92 "..\\..\\..\\..\\Source\\spi_master\\spi_master.c"
...
{
    do { const _Bool LOCAL_BOOLEAN_VALUE = (p_spi_instance != 0); if (!LOCAL_BOOLEAN_VALUE) { do { app_error_handler((0), 115, (uint8_t*) "..\\..\\..\\..\\Source\\spi_master\\spi_master.c"); } while (0); } } while (0);
...
{
    do { const _Bool LOCAL_BOOLEAN_VALUE = (pp_buf != 0); if (!LOCAL_BOOLEAN_VALUE) { do { app_error_handler((0), 148, (uint8_t*) "..\\..\\..\\..\\Source\\spi_master\\spi_master.c"); } while (0); } } while (0);
    do { const _Bool LOCAL_BOOLEAN_VALUE = (p_buf_len != 0); if (!LOCAL_BOOLEAN_VALUE) { do { app_error_handler((0), 149, (uint8_t*) "..\\..\\..\\..\\Source\\spi_master\\spi_master.c"); } while (0); } } while (0);
    do { const _Bool LOCAL_BOOLEAN_VALUE = (p_index != 0); if (!LOCAL_BOOLEAN_VALUE) { do { app_error_handler((0), 150, (uint8_t*) "..\\..\\..\\..\\Source\\spi_master\\spi_master.c"); } while (0); } } while (0);
...
static __inline void spi_master_buffer_release(uint8_t * volatile * const pp_buf,
                                               volatile uint16_t * const  p_buf_len)
{
    do { const _Bool LOCAL_BOOLEAN_VALUE = (pp_buf != 0); if (!LOCAL_BOOLEAN_VALUE) { do { app_error_handler((0), 163, (uint8_t*) "..\\..\\..\\..\\Source\\spi_master\\spi_master.c"); } while (0); } } while (0);
    do { const _Bool LOCAL_BOOLEAN_VALUE = (p_buf_len != 0); if (!LOCAL_BOOLEAN_VALUE) { do { app_error_handler((0), 164, (uint8_t*) "..\\..\\..\\..\\Source\\spi_master\\spi_master.c"); } while (0); } } while (0);
...
{
    do { const _Bool LOCAL_BOOLEAN_VALUE = (p_spi_instance != 0); if (!LOCAL_BOOLEAN_VALUE) { do { app_error_handler((0), 177, (uint8_t*) "..\\..\\..\\..\\Source\\spi_master\\spi_master.c"); } while (0); } } while (0);
...
{
    do { const _Bool LOCAL_BOOLEAN_VALUE = (p_spi_instance != 0); if (!LOCAL_BOOLEAN_VALUE) { do { app_error_handler((0), 194, (uint8_t*) "..\\..\\..\\..\\Source\\spi_master\\spi_master.c"); } while (0); } } while (0);
...
static __inline void spi_master_send_recv_irq(volatile spi_master_instance_t * const p_spi_instance)
{
    do { const _Bool LOCAL_BOOLEAN_VALUE = (p_spi_instance != 0); if (!LOCAL_BOOLEAN_VALUE) { do { app_error_handler((0), 218, (uint8_t*) "..\\..\\..\\..\\Source\\spi_master\\spi_master.c"); } while (0); } } while (0);
...
{		
    ...
    do { const _Bool LOCAL_BOOLEAN_VALUE = (p_spi_instance != 0); if (!LOCAL_BOOLEAN_VALUE) { do { app_error_handler((0), 276, (uint8_t*) "..\\..\\..\\..\\Source\\spi_master\\spi_master.c"); } while (0); } } while (0);
    ...
    do { const uint32_t LOCAL_ERR_CODE = (sd_nvic_ClearPendingIRQ(p_spi_instance ->irq_type)); if (LOCAL_ERR_CODE != ((0x0) + 0)) { do { app_error_handler((LOCAL_ERR_CODE), 323, (uint8_t*) "..\\..\\..\\..\\Source\\spi_master\\spi_master.c"); } while (0); } } while (0);
    do { const uint32_t LOCAL_ERR_CODE = (sd_nvic_SetPriority(p_spi_instance ->irq_type, p_spi_master_config->SPI_PriorityIRQ)); if (LOCAL_ERR_CODE != ((0x0) + 0)) { do { app_error_handler((LOCAL_ERR_CODE), 324, (uint8_t*) "..\\..\\..\\..\\Source\\spi_master\\spi_master.c"); } while (0); } } while (0);
    ...
    do { const uint32_t LOCAL_ERR_CODE = (sd_nvic_EnableIRQ(p_spi_instance ->irq_type)); if (LOCAL_ERR_CODE != ((0x0) + 0)) { do { app_error_handler((LOCAL_ERR_CODE), 331, (uint8_t*) "..\\..\\..\\..\\Source\\spi_master\\spi_master.c"); } while (0); } } while (0);
...
void spi_master_close(const spi_master_hw_instance_t spi_master_hw_instance)
{
    ...
    volatile spi_master_instance_t * p_spi_instance = spi_master_get_instance(
        spi_master_hw_instance);
    do { const _Bool LOCAL_BOOLEAN_VALUE = (p_spi_instance != 0); if (!LOCAL_BOOLEAN_VALUE) { do { app_error_handler((0), 351, (uint8_t*) "..\\..\\..\\..\\Source\\spi_master\\spi_master.c"); } while (0); } } while (0);

     
    do { const uint32_t LOCAL_ERR_CODE = (sd_nvic_ClearPendingIRQ(p_spi_instance ->irq_type)); if (LOCAL_ERR_CODE != ((0x0) + 0)) { do { app_error_handler((LOCAL_ERR_CODE), 354, (uint8_t*) "..\\..\\..\\..\\Source\\spi_master\\spi_master.c"); } while (0); } } while (0);
    do { const uint32_t LOCAL_ERR_CODE = (sd_nvic_DisableIRQ(p_spi_instance ->irq_type)); if (LOCAL_ERR_CODE != ((0x0) + 0)) { do { app_error_handler((LOCAL_ERR_CODE), 355, (uint8_t*) "..\\..\\..\\..\\Source\\spi_master\\spi_master.c"); } while (0); } } while (0);
    ...
    const spi_master_hw_instance_t spi_master_hw_instance)
{
    ...
    volatile spi_master_instance_t * p_spi_instance = spi_master_get_instance(
        spi_master_hw_instance);
    do { const _Bool LOCAL_BOOLEAN_VALUE = (p_spi_instance != 0); if (!LOCAL_BOOLEAN_VALUE) { do { app_error_handler((0), 381, (uint8_t*) "..\\..\\..\\..\\Source\\spi_master\\spi_master.c"); } while (0); } } while (0);
                                         ...
                                         spi_master_event_handler_t     event_handler)
{
    ...
    volatile spi_master_instance_t * p_spi_instance = spi_master_get_instance(
        spi_master_hw_instance);
    do { const _Bool LOCAL_BOOLEAN_VALUE = (p_spi_instance != 0); if (!LOCAL_BOOLEAN_VALUE) { do { app_error_handler((0), 395, (uint8_t*) "..\\..\\..\\..\\Source\\spi_master\\spi_master.c"); } while (0); } } while (0);
                              ...
                              uint8_t * const p_rx_buf, const uint16_t rx_buf_len)
{
    ...
    volatile spi_master_instance_t * p_spi_instance = spi_master_get_instance(
        spi_master_hw_instance);
    do { const _Bool LOCAL_BOOLEAN_VALUE = (p_spi_instance != 0); if (!LOCAL_BOOLEAN_VALUE) { do { app_error_handler((0), 411, (uint8_t*) "..\\..\\..\\..\\Source\\spi_master\\spi_master.c"); } while (0); } } while (0);
    ...
    if (p_spi_instance->disable_all_irq)
    {
        ...
        do { const uint32_t LOCAL_ERR_CODE = (sd_nvic_critical_region_enter(&nested_critical_region)); if (LOCAL_ERR_CODE != ((0x0) + 0)) { do { app_error_handler((LOCAL_ERR_CODE), 422, (uint8_t*) "..\\..\\..\\..\\Source\\spi_master\\spi_master.c"); } while (0); } } while (0);
    }
    else
    {
        
        do { const uint32_t LOCAL_ERR_CODE = (sd_nvic_DisableIRQ(p_spi_instance ->irq_type)); if (LOCAL_ERR_CODE != ((0x0) + 0)) { do { app_error_handler((LOCAL_ERR_CODE), 427, (uint8_t*) "..\\..\\..\\..\\Source\\spi_master\\spi_master.c"); } while (0); } } while (0);
    }
    ...
    {   
        ...
        do { const uint32_t LOCAL_ERR_CODE = (sd_nvic_critical_region_exit(nested_critical_region)); if (LOCAL_ERR_CODE != ((0x0) + 0)) { do { app_error_handler((LOCAL_ERR_CODE), 471, (uint8_t*) "..\\..\\..\\..\\Source\\spi_master\\spi_master.c"); } while (0); } } while (0);
    }
    else
    {
        
        do { const uint32_t LOCAL_ERR_CODE = (sd_nvic_EnableIRQ(p_spi_instance ->irq_type)); if (LOCAL_ERR_CODE != ((0x0) + 0)) { do { app_error_handler((LOCAL_ERR_CODE), 476, (uint8_t*) "..\\..\\..\\..\\Source\\spi_master\\spi_master.c"); } while (0); } } while (0);
    }
